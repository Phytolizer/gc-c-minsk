...
{
    struct LiteralExpressionSyntax *syntax = mc_malloc(sizeof(struct LiteralExpressionSyntax));
    expression_syntax_init((struct ExpressionSyntax *)syntax, EXPRESSION_SYNTAX_KIND_LITERAL_EXPRESSION_SYNTAX);
